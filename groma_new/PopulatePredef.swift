...
func populatePredefinedData(modelContext: ModelContext) {
    ...
    let predefinedData = [
        ...
        PredefItem(name: "in_red grapes".loc, price: 0, tag: fruits),
        PredefItem(name: "in_green grapes".loc, price: 0, tag: fruits),
        PredefItem(name: "in_black grapes".loc, price: 0, tag: fruits),
        ...
        PredefItem(name: "in_white onions".loc, price: 0, tag: veggies),
        PredefItem(name: "in_red onions".loc, price: 0, tag: veggies),
        ...
        PredefItem(name: "in_cheese cake".loc, price: 0, tag: sweets),
        ...
        PredefItem(name: "in_red whine", price: 0, tag: alcohol),
        PredefItem(name: "in_white whine", price: 0, tag: alcohol),
